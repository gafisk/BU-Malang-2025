...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['hapus']) && isset($_POST['id_berita'])) {
  ...
  if ($row = $result->fetch_assoc()) {
    ...
    if (!empty($gambar)) {
      $file_path = $_SERVER['DOCUMENT_ROOT'] . "/BU-Malang-2025/adminbu/assets/assets/berita/" . $gambar;
          ...
          <div class="row">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-end">
                ...
                <li class="breadcrumb-item"><a href="pages/berita/kelola-berita.php">Kelola Berita</a></li>
