    ...
    <main class="app-main">
      ...
      <div class="app-content-header">
        ...
        <div class="container-fluid">
          ...
          <div class="row">
            <div class="col-sm-6">
              <h3 class="mb-0">Daftar Jumlah Awardee</h3>
            </div>
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-end">
                <li class="breadcrumb-item"><a href="#">Home</a></li>
                <li class="breadcrumb-item active" aria-current="page">
                  Daftar Jumlah Awardee
                </li>
              </ol>
            </div>
          </div>
              ...
              <tbody>
                <?php foreach ($result as $row): ?>
                  <tr>
                    ...
                    <td>
                      <a href="/BU-MALANG-2025/adminbu/pages/kelola-stats/kelola-stats.php?id=<?= $row['id_stats']; ?>" class="btn btn-warning btn-sm">
                        Update Jumlah</i>
                      </a>
                    </td>
                  </tr>
