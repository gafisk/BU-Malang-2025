...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['hapus']) && isset($_POST['id_prestasi'])) {
  $id_prestasi = intval($_POST['id_prestasi']);

  // Ambil nama file gambar dari database
  $stmt = $conn->prepare("SELECT gambar FROM prestasi WHERE id_prestasi = ?");
  ...
  if ($row = $result->fetch_assoc()) {
    ...
    if (!empty($gambar)) {
      $file_path = $_SERVER['DOCUMENT_ROOT'] . "/BU-Malang-2025/adminbu/assets/assets/prestasi/" . $gambar;
          ...
          <div class="row">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-end">
                ...
                <li class="breadcrumb-item"><a href="pages/kelola-aktivitas/kelola-prestasi.php">Kelola Prestasi</a></li>
              ...
              <tbody>
                <?php while ($row = $result->fetch_assoc()): ?>
                  <tr>
                    ...
                    <td><?= htmlspecialchars($row['tingkat_prestasi']); ?></td>
                    <td><?= htmlspecialchars($row['nama_peraih']); ?></td>
                    <td><?= htmlspecialchars($row['asal_univ']); ?></td>
                    <td><?= htmlspecialchars($row['tahun_awardee']); ?></td>
                    <td>
                      <?php if (!empty($row['gambar'])): ?>
                        <img src="/BU-Malang-2025/adminbu/assets/assets/prestasi/<?= htmlspecialchars($row['gambar']); ?>" alt="Gambar prestasi" width="100">
                      <?php else: ?>
                    ...
                    <td>
                      <a href="/BU-Malang-2025/adminbu/pages/kelola-aktivitas/kelola-prestasi.php?id=<?= $row['id_prestasi']; ?>" class="btn btn-warning btn-sm">
