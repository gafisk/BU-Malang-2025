...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['hapus']) && isset($_POST['id_publikasi'])) {
  $id_publikasi = intval($_POST['id_publikasi']);

  // Hapus data dari database
  $stmt = $conn->prepare("DELETE FROM publikasi WHERE id_publikasi = ?");
          ...
          <div class="row">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-end">
                ...
                <li class="breadcrumb-item"><a href="pages/kelola-aktivitas/kelola-publikasi.php">Kelola Publikasi</a></li>
              ...
              <tbody>
                <?php while ($row = $result->fetch_assoc()): ?>
                  <tr>
                    ...
                    <td>
                      <?php
                      $words = explode(' ', $row['judul_publikasi']);
                      echo htmlspecialchars(implode(' ', array_slice($words, 0, 3))) . (count($words) > 3 ? '...' : '');
                      ?>
                    </td>
                    <td><?= htmlspecialchars($row['kategori_publikasi']); ?></td>
                    ...
                    <td>
                      <a href="/BU-Malang-2025/adminbu/pages/kelola-aktivitas/kelola-publikasi.php?id=<?= $row['id_publikasi']; ?>" class="btn btn-warning btn-sm">
                        <i class="bi bi-pencil"></i> </a>
                      <form method="POST" style="display:inline;" onsubmit="return confirmDelete();">
                        <input type="hidden" name="id_publikasi" value="<?= $row['id_publikasi']; ?>">
