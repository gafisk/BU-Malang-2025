    ...
    <main class="app-main">
      ...
      <div class="app-content-header">
        ...
        <div class="container-fluid">
          ...
          <div class="row">
            <div class="col-sm-6">
              <h3 class="mb-0">Kelola AD/ART</h3>
            </div>
            <div class="col-sm-6">
            ...
            <table id="dataproker" class="table table-striped" style="width:100%">
              ...
              <tbody>
                <?php foreach ($result as $row): ?>
                  <tr>
                    <td><?= $no++ ?></td>
                    <td><?= htmlspecialchars($row['link_adart']); ?></td>
                    <td>
                      <a href="/BU-MALANG-2025/adminbu/pages/kelola-profil/kelola-adart.php?id=<?= $row['id_pelaporan']; ?>" class="btn btn-warning btn-sm">
                        Update Link</i>
                      </a>
                    </td>
                  </tr>
