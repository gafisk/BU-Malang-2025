...
$allowed_users = [
  "bumalang" => '$2y$10$1rx3abAsNYXzEVAlqyKxK.92uR0arAaLDSr50/mW0sGKJsH2vzedq', // adminbu@2025!!!
  "gafisk" => '$2y$10$1ATVKM91ktivpJsQy1e1MO0oXI2WJLR1nGZN71ROkHRFkahgQRMnO'  // Galihrestu@123
];
...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
  ...
  if (isset($allowed_users[$username])) {
    ...
    if (password_verify($password, $allowed_users[$username])) {
